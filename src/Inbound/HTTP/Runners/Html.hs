...
import Core.Lib (DataUpdateIntervalSeconds (DataUpdateIntervalSeconds), Id (Id), Ref (Ref))
import Core.Runners
import Data.Map (toList)
import qualified Data.Text as T
import Data.Time (UTCTime, defaultTimeLocale, diffUTCTime, formatTime)
import Inbound.HTTP.Statuses.Html (AutoRefresh (Refresh))
import Polysemy
...
deriving newtype instance ToMarkup JobName

deriving newtype instance ToMarkup RunnerName
